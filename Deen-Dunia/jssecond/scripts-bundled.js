...
var Search = function () {
  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery2.default.getJSON(universityData.root_url + '/wp-json/deendunia/v1/search?term=' + this.searchField.val(), function (results) {
        ...
        }).join('') + "\n            " + (results.generalInfo.length ? '</ul>' : '') + "\n          </div>\n          <div class=\"half\">\n            <h2 class=\"search-overlay__section-title\">Books</h2>\n            " + (results.books.length ? '<ul class="link-list min-list">' : "<p>No Books match that search. <a href=\"" + universityData.root_url + "/BOOKS\">View all Books</a></p>") + "\n              " + results.books.map(function (item) {
          return "<li><a href=\"" + item.permalink + "\">" + item.title + "</a></li>";
        }).join('') + "\n            " + (results.books.length ? '</ul>' : '') +  " \n            <h2 class=\"search-overlay__section-title\">Masik Deen Dunia</h2>\n            " + (results.masikdeendunias.length ? '<ul class="link-list min-list">' : "<p>No Masik Deen Dunia match that search. <a href=\"" + universityData.root_url + "/masik-deen-dunia\">View all Masik Deen Dunia</a></p>") + "\n              " + results.masikdeendunias.map(function (item) {
          return "<li><a href=\"" + item.permalink + "\">" + item.title + "</a></li>";
        }).join('') + "\n            " + (results.masikdeendunias.length ? '</ul>' : '') +  " \n            <h2 class=\"search-overlay__section-title\">Shishu Kishor Deen Dunia</h2>\n            " + (results.kishordeendunia.length ? '<ul class="link-list min-list">' : "<p>No Shishu Kishor Deen Dunia match that search. <a href=\"" + universityData.root_url + "/shishu-kishor-deen-dunia\">View all Shishu Kishor Deen Dunia</a></p>") + "\n              " + results.kishordeendunia.map(function (item) {
          return "<li><a href=\"" + item.permalink + "\">" + item.title + "</a></li>";
        }).join('') + "\n            " + (results.kishordeendunia.length ? '</ul>' : '') +  "\n         </div>\n         </div>\n      ");
