		...
		<div class="container">
			<div class="row">
				...
				<div class="Collect-our-Books Our-upcoming-books">
					<a href="<?php echo site_url('/BOOKS');?>"><h3>Published Books</h3></a>
			...
			<div class="row course_boxes">
				...
				<?php
					endwhile; 
						else: echo'<h1 style="color:red;font-size:50px;margin:0 auto;">No Upcoming Books</h1>';
					endif;
