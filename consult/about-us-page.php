                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-6">
                                            <div class="image_fulwidth wow fadeInLeft" data-wow-delay="300ms">
                                                <img src="images/our_vision_left_pic.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-6">
                                            <div class="image_fulwidth">
                                                <img src="images/our_vision_left_pic04.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="tab_text_ser para_default">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="Desiagns">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-6">
                                            <div class="image_fulwidth">
                                                <img src="images/our_vision_left_pic05.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="tab_text_ser para_default">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="RESPONSIVE">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-6">
                                            <div class="image_fulwidth">
                                                <img src="images/our_vision_left_pic03.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="tab_text_ser para_default">
