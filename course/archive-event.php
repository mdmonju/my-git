<?php get_header();?>
	...
	<!-- News -->
			<div class="checkout-element">
				<a href="<?php echo site_url('/past-events');?>">Checkout our past event archive</a>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<?php
					endwhile;
					else: echo'<h1 style="color:red;font-size:100px;">Sorry!</h1>';
						echo'<h1 style="color:red;font-size:100px;">No Events Found</h1>';
					endif;
