...
var Search = function () {
  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery2.default.getJSON(universityData.root_url + '/wp-json/course/v1/search?term=' + this.searchField.val(), function (results) {
        ...
        }).join('') + "\n            " + (results.generalInfo.length ? '</ul>' : '') + "\n          </div>\n          <div class=\"one-third\">\n            <h2 class=\"search-overlay__section-title\">Courses</h2>\n            " + (results.courses.length ? '<ul class="link-list min-list">' : "<p>No courses match that search. <a href=\"" + universityData.root_url + "/Courses\">View all Courses</a></p>") + "\n              " + results.courses.map(function (item) {
          return "<li><a href=\"" + item.permalink + "\">" + item.title + "</a></li>";
        }).join('') + "\n            " + (results.courses.length ? '</ul>' : '') + "\n\n            <h2 class=\"search-overlay__section-title\">Teachers</h2>\n " + (results.teachers.length ? '<ul class="link-list min-list">' : "<p>No Teachers match that search. <a href=\"" + universityData.root_url + "/Teachers\">View all Teachers</a></p>") + "\n              " + results.teachers.map(function (item) {
          return "<li><a href=\"" + item.permalink + "\">" + item.title + "</a></li>";
        }).join('') + "\n            " + (results.teachers.length ? '</ul>' : '') + " \n                                           <h2 class=\"search-overlay__section-title\">Services</h2>\n " + (results.services.length ? '<ul class="link-list min-list">' : "<p>No services match that search. <a href=\"" + universityData.root_url + "/Services\">View all Services</a></p>") + "\n              " + results.services.map(function (item) {
          return "<li><a href=\"" + item.permalink + "\">" + item.title + "</a></li>";
        }).join('') + "\n            " + (results.services.length ? '</ul>' : '') + " \n          </div>\n          <div class=\"one-third\">\n            <h2 class=\"search-overlay__section-title\">Libraries</h2>\n            " + (results.libraries.length ? '<ul class="link-list min-list">' : "<p>No Libraries match that search. <a href=\"" + universityData.root_url + "/libraries\">View all Libraries</a></p>") + "\n              " + results.libraries.map(function (item) {
          return "<li><a href=\"" + item.permalink + "\">" + item.title + "</a></li>";
        }).join('') + "\n            " + (results.libraries.length ? '</ul>' : '') + "\n\n            <h2 class=\"search-overlay__section-title\">Events</h2>\n " + (results.events.length ? '<ul class="link-list min-list">' : "<p>No events match that search. <a href=\"" + universityData.root_url + "/Events\">View all Events</a></p>") + "\n              " + results.events.map(function (item) {
          return "<li><a href=\"" + item.permalink + "\">" + item.title + "</a></li>";
        }).join('') + "\n            " + (results.events.length ? '</ul>' : '') + "         </div>\n        </div>\n      ");
